...
namespace EaziLease.Data
{
    public static class SeedData
    {
        public static async Task InitializeAsync(ApplicationDbContext context)
        {
            ...
            var suppliers = new[]
            {
                new Supplier { Name = "AutoFleet Imports",      ContactPerson = "Sarah Naidoo",    ContactEmail = "sarah@autofleet.co.za", ContactPhone = "011 234 5678", City = "Johannesburg" },
                new Supplier { Name = "Cape Vehicle Wholesalers", ContactPerson = "Johan van Wyk", ContactEmail = "johan@cvw.co.za",     ContactPhone = "021 876 5432", City = "Cape Town" },
                new Supplier { Name = "Durban Motor Traders",   ContactPerson = "Priya Singh",     ContactEmail = "priya@dmt.co.za",       ContactPhone = "031 456 7890", City = "Durban" },
                new Supplier { Name = "Pretoria Car Brokers",   ContactPerson = "Marcus Botha",    ContactEmail = "marcus@pcb.co.za",      ContactPhone = "012 345 6789", City = "Pretoria" },
                new Supplier { Name = "National Fleet Direct",  ContactPerson = "Linda Mokoena",   ContactEmail = "linda@nfd.co.za",       ContactPhone = "087 123 4567", City = "Sandton" }
            };
